...
class Act extends StatefulWidget {
  Act({Key key, this.title}) : super(key: key);
...
class _ListPageState extends State<Act> {
  ...
  Future<String> makeRequest() async {
    ...
    String url = 'http://10.0.2.2:8000/api/act/${patient_id}';
  ...
  Widget build(BuildContext context) {
    ...
    ListTile makeListTile(Map<String, dynamic> act,Map<String,dynamic> patien) => ListTile(
        contentPadding:
        ...
        onTap: () {
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  ...
                  builder: (context) => DetailAct(actes:act,patien:patient,age:ye)));
        }
    );

    Card makeCard(Map<String, dynamic> act) => Card(
      elevation: 8.0,
      margin: new EdgeInsets.symmetric(horizontal: 10.0, vertical: 6.0),
      child: Container(
        decoration: BoxDecoration(color: Color.fromRGBO(70, 239, 239, 239)),
        child: makeListTile(act,patient),
      ),
    );
