...
import 'details/detailMedicament.dart';
import 'dart:async';
import 'dart:convert';
...
class Medicament extends StatefulWidget {
  Medicament({Key key, this.title}) : super(key: key);
...
class _ListPageState extends State<Medicament> {
  ...
  Widget build(BuildContext context){
    ...
    ListTile makeListTile(Map<String, dynamic> prescription,Map<String,dynamic> patien,int i) => ListTile(
        contentPadding:
          ...
          children: <Widget>[
            Expanded(
              ...
              child: Padding(
                  ...
                  child: Text(prescription["date_prescription"],
    ...
    Card makeCard(Map<String, dynamic> prescription,int i) => Card(
      elevation: 8.0,
      margin: new EdgeInsets.symmetric(horizontal: 10.0, vertical: 6.0),
      child: Container(
        decoration: BoxDecoration(color: Color.fromRGBO(70, 239, 239, 239)),
        child: makeListTile(prescription,patient,i),
      ),
    );
    ...
    final makeBody = Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return makeCard(prescriptions[index],index+1);
        },
      ),
    );
