...
import 'details/detailConsultation.dart';
import 'dart:async';
import 'dart:convert';
...
class Consultation extends StatefulWidget {
  Consultation({Key key, this.title}) : super(key: key);
...
class _ListPageState extends State<Consultation> {
  ...
  Future<String> makeRequest() async {
    ...
    String url = 'http://10.0.2.2:8000/api/consultation/${patient_id}';
    ...
    setState(() {
      ...
      if(response.statusCode==200) {
        ...
        consultations= extractdata["Consultation"];
  ...
  Widget build(BuildContext context) {
    ...
    ListTile makeListTile(Map<String, dynamic> consultation,Map<String,dynamic> patien) => ListTile(
      contentPadding:
      ...
      title: Text(
        capitalizeFirstLetter(consultation["motif"]),
        ...
        children: <Widget>[
          Expanded(
            ...
            child: Padding(
                ...
                child: Text(consultation["date_consultation"],
      ...
      Icon(Icons.keyboard_arrow_right, color: Color.fromARGB(250, 92, 92, 92), size: 30.0),
        ...
        onTap: () {
           ...
           Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => DetailConsultation(consultationes:consultation,patien:patient,age: ye,)));
        }
    );

    Card makeCard(Map<String, dynamic> consultation) => Card(
      elevation: 8.0,
      margin: new EdgeInsets.symmetric(horizontal: 10.0, vertical: 6.0),
      child: Container(
        decoration: BoxDecoration(color: Color.fromRGBO(70, 239, 239, 239)),
        child: makeListTile(consultation,patient),
      ),
    );
    ...
    final makeBody = Container(
      ...
      child: ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: consultations == null ? 0 : consultations.length,
        itemBuilder: (BuildContext context, int index) {
            return makeCard(consultations[index]);
        },
      ),
    );
