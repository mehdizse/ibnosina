...
import 'details/detailAutomedication.dart';
import 'dart:async';
import 'dart:convert';
...
class Automedication extends StatefulWidget {
  Automedication({Key key, this.title}) : super(key: key);
...
class _ListPageState extends State<Automedication> {
  ...
  Widget build(BuildContext context){
    ...
    ListTile makeListTile(Map<String, dynamic> automedication,Map<String,dynamic> patien,int i) => ListTile(
        contentPadding:
          ...
          children: <Widget>[
            Expanded(
              ...
              child: Padding(
                  ...
                  child: Text(automedication["date_automedication"],
        ...
        onTap: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => DetailAutomedication(automedication_id:automedication["id"])));
        }
    );
    ...
    final makeBody = Container(
      ...
      child: ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: automedications == null ? 0 : automedications.length,
        itemBuilder: (BuildContext context, int index) {
          return makeCard(automedications[index],index+1);
        },
      ),
    );
