...
import 'chroniques.dart';



class Historique extends StatefulWidget {
  Historique({Key key, this.title}) : super(key: key);
...
class _ListPageState extends State<Historique> {
  ...
  Widget build(BuildContext context) {
    ...
    ListTile makeListTile(String ecr,Map<String,dynamic> patien,String link) => ListTile(
        contentPadding:
        ...
        onTap: () {
           if(link =="/automedication"){
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) =>
                        Automedication(title:'automedication')));
          }else if(link =="/chroniques"){
             Navigator.push(
                 context,
                 MaterialPageRoute(
                     builder: (context) =>
                         Chroniques(title:'Traitement Chronique')));
           }
    ...
    Card makeCard(String ecr,String link) => Card(
      elevation: 8.0,
      margin: new EdgeInsets.symmetric(horizontal: 10.0, vertical: 6.0),
      child: Container(
        decoration: BoxDecoration(color: Color.fromRGBO(70, 239, 239, 239)),
        child: makeListTile(ecr,patient,link),
      ),
    );
        ...
        child: new Column(
          ...
          children: <Widget>[
            new Expanded(
                child:Column(
                  children: <Widget>[
                    makeCard("Prescriptions Hospitalières","/medicament"),
                    makeCard("Prescriptions Ville","/chroniques"),
                    makeCard("Automedications","/automedication"),
