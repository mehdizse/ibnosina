...
class Chronique extends StatefulWidget {
  Chronique({Key key, this.title}) : super(key: key);
...
class _ListPageState extends State<Chronique> {
  ...
  Future<String> makeRequest() async {
    ...
    String url = 'http://10.0.2.2:8000/api/m/${patient_id}';
  ...
  Widget build(BuildContext context) {
    ...
    ListTile makeListTile(Map<String, dynamic> chronique,Map<String,dynamic> patien,int index) => ListTile(
        contentPadding:
        EdgeInsets.symmetric(horizontal: 20.0, vertical: 10.0),
        leading: Container(
          padding: EdgeInsets.only(right: 12.0,top:9),
          decoration: new BoxDecoration(
              border: new Border(
                  right: new BorderSide(width: 1.0, color: Colors.white24))),
          child: Text("${index}/${total}", style:TextStyle(color: Color.fromARGB(250, 92, 92, 92))),
        ),
        title: Text(
          ...
          children: <Widget>[
            Expanded(
              ...
              child: Padding(
                  ...
                  child: Text("${chronique["cosac_dosage"]}${chronique["cosac_unitedosage"]}  ${chronique["total"]} fois par jour",
    ...
    Card makeCard(Map<String, dynamic> chronique,int index) => Card(
      elevation: 8.0,
      margin: new EdgeInsets.symmetric(horizontal: 10.0, vertical: 6.0),
      child: Container(
        decoration: BoxDecoration(color: Color.fromRGBO(70, 239, 239, 239)),
        child: makeListTile(chronique,patient,index),
      ),
    );
    ...
    final makeBody = Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return makeCard(chroniques[index],index+1);
        },
      ),
    );
