...
import 'details/detailHospitalisation.dart';
import 'dart:async';
import 'dart:convert';
...
class Hospitalisation extends StatefulWidget {
  Hospitalisation({Key key, this.title}) : super(key: key);
...
class _ListPageState extends State<Hospitalisation> {

  List data;
  Map<String,dynamic> patient;
  List<dynamic> hospitalisations;
  var ye;
  var nom;
  double _imageHeight ;
  var photo;
  Future<String> makeRequest() async {
    ...
    String url = 'http://10.0.2.2:8000/api/hospitalisation/${patient_id}';
    ...
    setState(() {
      ...
      if(response.statusCode==200) {
        ...
        hospitalisations= extractdata["Hospitalisation"];
  ...
  Widget build(BuildContext context) {
    ...
    ListTile makeListTile(Map<String, dynamic> hospitalisation,Map<String,dynamic> patien) => ListTile(
        contentPadding:
        ...
        title: Text(
          capitalizeFirstLetter(hospitalisation["motifs"]),
          ...
          children: <Widget>[
            Expanded(
              ...
              child: Padding(
                  ...
                  child: Text(hospitalisation["date_admission"],
        ...
        onTap: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => DetailHospitalisation(hospitalisationes:hospitalisation,patien:patient,age:ye)));
        }
    );

    Card makeCard(Map<String, dynamic> hospitalisation) => Card(
      elevation: 8.0,
      margin: new EdgeInsets.symmetric(horizontal: 10.0, vertical: 6.0),
      child: Container(
        decoration: BoxDecoration(color: Color.fromRGBO(70, 239, 239, 239)),
        child: makeListTile(hospitalisation,patient),
      ),
    );
    ...
    final makeBody = Container(
      ...
      child: ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: hospitalisations == null ? 0 : hospitalisations.length,
        itemBuilder: (BuildContext context, int index) {
          return makeCard(hospitalisations[index]);
        },
      ),
    );
