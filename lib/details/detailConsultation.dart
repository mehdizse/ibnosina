...
class DetailConsultation extends StatelessWidget {
  int age;
  double _imageHeight;
  Map<String,dynamic> consultationes;
  Map<String,dynamic> patien;
  DetailConsultation({Key key, this.consultationes,this.patien,this.age}) : super(key: key);
        ...
        child: new Row(
          children: <Widget>[
            new CircleAvatar(
              minRadius: 32.0,
              maxRadius: 32.0,
              backgroundImage: new NetworkImage('http://10.0.2.2:/avatar/${patien["photo"]}'),
            ),
            new Padding(
      ...
      child: new SingleChildScrollView(
          child:Container(
              child: Column(
                ...
                children: <Widget>[
                  _buildWi(_buildText("Motif",context), _buildText2("${consultationes["motif"]}",context)),
                  _buildWi(_buildText("Signe Formelle",context), _buildText2("${consultationes["signe"]}" ,context)),
                  _buildWi(_buildText("Examen",context), _buildText2("${consultationes["examen"]}",context)),
                  _buildWi(_buildText("Compte Rendu",context), _buildText2("${consultationes["compte_rendu"]}",context)),
                  _buildWi(_buildText("Date",context), _buildText2("${consultationes["date_consultation"]}",context)),
