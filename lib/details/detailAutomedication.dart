...
class DetailAutomedication extends StatefulWidget {
  int automedication_id;
  DetailAutomedication({Key key, this.title,this.automedication_id}) : super(key: key);

  final String title;

  @override
  _ListPageState createState() => _ListPageState(automedication_id);
}

class _ListPageState extends State<DetailAutomedication> {
  int automedication_id;
  _ListPageState(int automedication_id){
      this.automedication_id=automedication_id;
  }

  List data;
  Map<String,dynamic> patient;
  List<dynamic> automedications;
  List<dynamic> auto;
  var ye;
  var nom;
  double _imageHeight;
  ...
  Future<String> makeRequest() async {
    ...
    String url = 'http://10.0.2.2:8000/api/automedication/${patient_id}';
    ...
    setState(() {
      ...
      if(response.statusCode==200) {
        ...
        automedications= extractdata["Automedication"];
        photo="${patient["photo"]}";
        ...
        for(var i in automedications){
          if(i["id"]==automedication_id){
            auto=i["automedication"];
          }
        }
      }
    });
        ...
        child: new Row(
          children: <Widget>[
            new CircleAvatar(
              minRadius: 32.0,
              maxRadius: 32.0,
              backgroundImage: new NetworkImage('http://10.0.0.2:800/avatar/${photo}'),
            ),
            new Padding(
  ...
  Widget build(BuildContext context){
          ...
          children: <Widget>[
            Expanded(
              ...
              child: Padding(
                  ...
                  child: Text("${medicament["cosac_dosage"]} ${medicament["cosac_unitedosage"]}",
    ...
    Card makeCard(Map<String, dynamic> automedication,int i) => Card(
      elevation: 8.0,
      margin: new EdgeInsets.symmetric(horizontal: 10.0, vertical: 6.0),
      child: Container(
        decoration: BoxDecoration(color: Color.fromRGBO(70, 239, 239, 239)),
        child: makeListTile(automedication,patient,i),
      ),
    );
    ...
    final makeBody = Container(
      ...
      child: ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: auto == null ? 0 : auto.length,
        itemBuilder: (BuildContext context, int index) {
          return makeCard(auto[index],index+1);
        },
      ),
    );
