...
class DetailPhyto extends StatelessWidget {
  Map<String,dynamic> phytoes;
  Map<String,dynamic> patien;
  int age;
  double _imageHeight;
  DetailPhyto({Key key, this.phytoes,this.patien,this.age}) : super(key: key);
      ...
      child: new SingleChildScrollView(
          child:Container(
              child: Column(
                ...
                children: <Widget>[
                  _buildWi(_buildText("Nom Fr",context), _buildText2("${phytoes["produit_naturel_fr"]}",context)),
                  _buildWi(_buildText("Nom Ar",context), _buildText2("${phytoes["produits_arabe"]}" ,context)),
                  _buildWi(_buildText("Nom Latin",context), _buildText2("${phytoes["produit_naturel_latin"]}",context)),
                  _buildWi(_buildText("Frequence",context), _buildText2("${phytoes["frequence"]}",context)),
                  _buildWi(_buildText("Date Phyto",context), _buildText2("${phytoes["date_phyto"]}",context)),
                ],
              ))),
    );
